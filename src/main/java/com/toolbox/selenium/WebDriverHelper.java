...
public class WebDriverHelper {
    ...
    public static WebElement stableFindElement(WebDriver driver, By by, int refreshTimeInMilliSec) throws WebDriverException {
    ...
    public static List<WebElement> stableFindElements(WebDriver driver, By by, int refreshTimeInMilliSec) throws WebDriverException {
    ...
    public static WebElement delayedStableFindElement(WebDriver driver, By by, int pollingTime, int dealyInMs) throws WebDriverException {
        sleep(dealyInMs);
    ...
    public static boolean waitUntilElementContainsAttribute(WebDriver driver, By locatorToWait, String attributeName, String attributeContent, int timeOutInMills) {
        int counter = 0;
        boolean isFound = false;
    ...
    public static boolean waitUntilElementText(WebDriver driver, By locatorToWait, String text, long timeOutInMills) {
        int counter = 0;
    ...
    public static String stableFindGetText(WebDriver driver, By by) throws WebDriverException {
        String elmText = null;
        WebDriverException webDrvExp = null;
        for (int attempts = 0; attempts < 3; attempts++) {
            try {
    ...
    public static String stableFindGetText(WebDriver driver, By by, int attemptsPerElementFound, int textRefreshTimeInMilliSec) {
    ...
    public static String stableFindGetAttribute(WebDriver driver, By by, String attrName) throws WebDriverException {
    ...
    public static void safeSendKeys(WebDriver driver, By by, String keysToSend) {
        sleep(500);
        driver.findElement(by).sendKeys(keysToSend);
    }

    public static void stableClearSendKeys(WebDriver driver, By by, String keysToSend) throws WebDriverException {
        WebDriverException webDrvExp = null;
        for (int attempts = 0; attempts < 3; attempts++) {
            try {
    ...
    public static void releaseActiveFocus(WebDriver driver) {
    ...
    public static void stableScrollToElement(WebDriver driver, By by) {
        for (int attempts = 0; attempts < 3; attempts++) {
            try {
    ...
    public static boolean isCheckBoxChecked(WebDriver driver, By byCheckBoxPath) {
    ...
    public static String getAllTextInPage(WebDriver driver) {
